...
import { PlusCircle, Play, Pause, Power, Repeat, Sparkles, MapPin } from 'lucide-react';
            ...
            <DialogContent>
                ...
                {isEncounterLoading ? (
                    ...
                    <div className="text-center space-y-4">
                        <Image src={`https://picsum.photos/seed/${encounter.pokemonName}/200/200`} alt={encounter.pokemonName} width={150} height={150} className="mx-auto" />
                        <p className="text-2xl font-bold flex items-center justify-center gap-2">
                           {encounter.pokemonName}
                           {encounter.isShiny && <Sparkles className="h-6 w-6 text-accent-foreground fill-accent" />}
                        </p>
